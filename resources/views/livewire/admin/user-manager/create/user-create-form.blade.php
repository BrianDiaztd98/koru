<div class="admin-form-panel" x-data="passwordStrength()">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h3 class="text-lg font-semibold text-white">New User</h3>
            <p class="text-sm text-slate-400">Create a new administrative account.</p>
        </div>
    ...
    <form wire:submit.prevent="save" class="grid gap-5 md:grid-cols-2 mt-6">
        ...
        <div class="md:col-span-2">
            ...
            <input type="password" wire:model.defer="password_confirmation" class="admin-input" placeholder="Confirm password" />
