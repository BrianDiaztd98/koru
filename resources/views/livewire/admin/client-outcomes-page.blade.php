...
<div class="lg:col-span-3 space-y-6">
    <div class="rounded-2xl border border-slate-800/80 bg-slate-900/20 backdrop-blur-xl p-6 sm:p-8 shadow-2xl shadow-black/40">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-xl font-bold text-white tracking-tight">Client Outcomes</h2>
                <p class="mt-1 text-sm text-slate-400">Manage the stories shown in the landing page section.</p>
            </div>
            @unless($showForm)
