                ...
                <table class="shell" role="presentation" width="760" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 760px;">
                    <tr>
                        <td style="padding: 0 0 18px 4px;">
                            ...
                            <p style="margin: 8px 0 0; color: #087f88; font-size: 11px; font-weight: bold; letter-spacing: 1.5px; text-transform: uppercase;">PAIN FREE, BETTER LIFE.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="overflow: hidden; border-radius: 14px; background: #ffffff; box-shadow: 0 10px 30px rgba(32, 49, 58, 0.08);">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 38px 46px; background: #0b2630;">
                                        <p style="margin: 0 0 10px; color: #6edbe0; font-size: 11px; font-weight: bold; letter-spacing: 2px; text-transform: uppercase;">Professional CE</p>
                                ...
                                <tr>
                                    <td class="content" style="padding: 42px 46px;">
                                        ...
                                        <h2 style="margin: 0 0 28px; color: #0b2630; font-size: 22px; line-height: 1.3;">{{ $enrollment->course?->title_en ?? 'Course unavailable' }}</h2>
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 28px; background: #f2f8f8; border-left: 4px solid #0eb3b9;">
                                            <tr>
                                        ...
                                        <p style="margin: 0 0 14px; color: #0b2630; font-size: 15px; font-weight: bold;">Participant details</p>
                                        <table class="two-col" role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 8px;">
                                            ...
                                            <tr>
                                                <td width="50%" style="padding: 0 18px 18px 0; vertical-align: top;">
                                                    ...
                                                    <a href="mailto:{{ $enrollment->email }}" style="color: #087f88; font-size: 15px; line-height: 1.4; text-decoration: none;">{{ $enrollment->email }}</a>
                                                </td>
                                                <td width="50%" style="padding: 0 0 18px; vertical-align: top;">
                                        ...
                                        @if ($enrollment->message)
                                            <div style="margin-top: 8px; padding-top: 22px; border-top: 1px solid #e2eaec;">
                                                <p style="margin: 0 0 8px; color: #0b2630; font-size: 15px; font-weight: bold;">Participant message</p>
